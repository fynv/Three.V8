...
HemisphereSkyTuner::HemisphereSkyTuner(QWidget* parent, const QJsonObject& jobj)
	: Tuner(parent, jobj)
{
	m_ui.setupUi(this);
...
HemisphereSkyTuner::~HemisphereSkyTuner()
{

}

void HemisphereSkyTuner::tuner_sky_color_ValueChanged()
{
	float r, g, b;
...
void HemisphereSkyTuner::tuner_ground_color_ValueChanged()
{
	float r, g, b;
