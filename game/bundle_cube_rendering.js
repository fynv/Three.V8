...
{   
    ...
    let cube_target = new CubeRenderTarget(512,512);
    renderer.renderCube(scene, cube_target, new Vector3(0.0, 0.0, 0.0));
    let target_img = cube_target.getCubeImage();
    imageSaver.saveCubeToFile(target_img, "face0.png", "face1.png", "face2.png", "face3.png", "face4.png", "face5.png");
}
