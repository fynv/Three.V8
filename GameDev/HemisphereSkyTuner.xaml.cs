...
{
    /// <summary>
    /// Interaction logic for HemisphereSkyTuner.xaml
    /// </summary>
    public partial class HemisphereSkyTuner : UserControl
    {
        private CGamePlayer game_player = null;
        private JObject jobj = null;

        public HemisphereSkyTuner(CGamePlayer game_player, JObject jobj)
        {
            InitializeComponent();
