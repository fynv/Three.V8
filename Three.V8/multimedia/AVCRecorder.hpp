...
v8::Local<v8::FunctionTemplate> WrapperAVCRecorder::create_template(v8::Isolate* isolate, v8::FunctionCallback constructor)
{
...
void WrapperAVCRecorder::New(const v8::FunctionCallbackInfo<v8::Value>& info)
{
