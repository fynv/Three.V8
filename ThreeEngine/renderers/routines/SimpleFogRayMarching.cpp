...
#include "SimpleFogRayMarching.h"
...
SimpleFogRayMarching::SimpleFogRayMarching(bool msaa) : m_msaa(msaa)
{
	std::string defines = "";
	if (msaa)
	{
...
void SimpleFogRayMarching::_render_no_shadow(const RenderParams& params)
{
...
void SimpleFogRayMarching::_render_shadowed(const RenderParams& params)
{
	glDisable(GL_CULL_FACE);
...
void SimpleFogRayMarching::render(const RenderParams& params)
{
